...
function format(text, path) {
    const config = vscode_1.workspace.getConfiguration('prettier-space-parenthesis');
    /*
    ...
    */
    ...
    const prettier = requirePkg_1.requireLocalPkg(path, 'prettier-space-parenthesis');
